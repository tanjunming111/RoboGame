# step10_aruco_id2_pose_estimation.py
# 标定第10步：识别 ArUco.png 中的标记 ID=2，实时估计相机位姿
# ============================================================
...
#
#   result['is_detected']     # bool，是否检测到ID=2
...
TARGET_MARKER_ID = 2                        # 本文件只识别 ID=2
...
def main():
    ...
    print("\n" + "=" * 60)
    print("标定第10步：单标记位姿估计（ArUco.png, ID=2, AprilTag36h11）")
    print("=" * 60)
    print()
    print("原理：")
    print("  1. 检测AprilTag36h11标记ID=2 → 2D角点")
