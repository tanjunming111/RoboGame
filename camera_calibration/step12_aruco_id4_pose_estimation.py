# step12_aruco_id4_pose_estimation.py
# 标定第12步：识别 ArUco.png 中的标记 ID=4，实时估计相机位姿
# ============================================================
...
#
#   result['is_detected']     # bool，是否检测到ID=4
...
TARGET_MARKER_ID = 4                        # 本文件只识别 ID=4
...
def main():
    ...
    print("\n" + "=" * 60)
    print("标定第12步：单标记位姿估计（ArUco.png, ID=4, AprilTag36h11）")
    print("=" * 60)
    print()
    print("原理：")
    print("  1. 检测AprilTag36h11标记ID=4 → 2D角点")
