# step09_aruco_id1_pose_estimation.py
# 标定第9步：识别 ArUco.png 中的标记 ID=1，实时估计相机位姿
# ============================================================
...
#
#   result['is_detected']     # bool，是否检测到ID=1
...
def main():
    ...
    print("\n" + "=" * 60)
    print("标定第9步：单标记位姿估计（ArUco.png, ID=1, AprilTag36h11）")
    print("=" * 60)
    print()
    print("原理：")
    print("  1. 检测AprilTag36h11标记ID=1 → 2D角点")
